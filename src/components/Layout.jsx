  ...
  return (
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div>
          <div className="footer-brand">
            <img src="/favicon.svg" alt="IBR Maragogi" className="brand-logo brand-logo-sm" />
            <span>IBR Maragogi</span>
          </div>
          <p>
            Igreja Batista Reformada, pregando Cristo e edificando vidas no
            litoral de Alagoas.
          </p>
        ...
        <div>
          ...
          <div className="footer-contact">
            <a href="mailto:contato@ibrmaragogi.org.br">
              <i className="ti ti-mail" aria-hidden="true" />
              contato@ibrmaragogi.org.br
            </a>
            <a href="tel:+5582999999999">
              <i className="ti ti-phone" aria-hidden="true" />
              (82) 99999-9999
            </a>
            <a href="https://wa.me/5582999999999">
      ...
      <div className="footer-bottom">
        <div>
          © 2025 IBR Maragogi · Todos os direitos reservados · Soli Deo Gloria
        </div>
      </div>
    </footer>
  );
      ...
      <div id="ibrContent">
        ...
        <header id="ibrTopbar">
          <div className="topbar-brand">
            <img src="/favicon.svg" alt="IBR Maragogi" className="brand-logo brand-logo-xs" />
